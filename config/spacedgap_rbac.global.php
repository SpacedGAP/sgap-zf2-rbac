...
return array(
    ...
    'zfcuser' => array(
         ...
         */       
        'user_entity_class' => 'SpacedGAPRbac\Entity\User',
         ...
         * ZfcUserDoctrineORM
         *
         * Boolean value, determines if the default User entity should be enabled.
         * Set it to false in order to extend ZfcUser\Entity\User with your own entity. Default is true.
         */
    ...
    'zfc_rbac' => array(
        ...
        'role_provider' => array(
            'ZfcRbac\Role\ObjectRepositoryRoleProvider' => array(
                ...
                'class_name'         => 'AppUser\Entity\Role',
